	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Cupones [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Categorías - NUEVO</a></li>

					</ul>
				</div>

				<form action="cupones.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
										...
										<div class="tab-pane fade active in" id="es">
											...
											<div class="form-group">
												...
												<div style="display:flex; justify-content: space-between">
													<div>
														<input type="radio" name="tipo" id="tipo" value="fijo"> Fijo
													</div>

													<div>
														<input type="radio" name="tipo" id="tipo" value="porcentaje"> Porcentaje
													</div>
											...
											<div class="form-group">
												...
												<input type="text" name="minimo_compra" id="minimo_compra" class="form-control">
											</div>

											<div class="form-group">
												<label class="control-label">Usos</label>
												<input type="text" name="usos" id="usos" class="form-control">
											</div>
