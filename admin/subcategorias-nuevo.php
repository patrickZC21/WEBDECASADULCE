...
<head>
	<meta charset="utf-8" />
	<title>SubCategorías nuevo</title>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">SubCategorías - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="subcategorias.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
									...
									<select name="id_categoria" class="form-control">
										...
										<?php  $con = mysqli_query($link, "select * from categorias where estatus='si'");
												while($row=mysqli_fetch_assoc($con){
													...
													<option value="<?=$row["id"]?>"><?=$row["nombre_es"]?></option>
