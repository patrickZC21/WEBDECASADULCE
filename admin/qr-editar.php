...
$consulta = mysqli_fetch_array(mysqli_query($link, "select * from qr_codes where id=" . $_GET["id"] . ""));
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="qr.php">QR CODES</a></li>
				<li class="active">QR CODES [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
				<form action="qr.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
									...
									<ul class="nav nav-tabs" id="nav-tabs">
										...
										<div class="tab-content tab-content-bordered">
											...
											<div class="form-group">
												<label class="control-label">Texto del código QR:</label>
												<input type="text" name="text" id="text" class="form-control" value="<?= $consulta["text"] ?>">
											</div>
