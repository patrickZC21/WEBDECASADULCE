...
if (isset($_POST["btn_guardar"])){
		...
		nosotros='".mysqli_real_escape_string($link,$_POST["contenido"])."'
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Acerca de Nosotros</a></li>
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-10 col-md-offset-1">
									...
									<div class="result">
											<textarea id="area_editor" name="contenido"><?=$informativos["nosotros"]?></textarea>
										</div>
