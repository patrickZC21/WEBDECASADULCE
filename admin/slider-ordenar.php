...
<head>
	<meta charset="utf-8" />
	<title>Imágenes Carousel Home ordenar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Imágenes Carousel Home [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
...
echo '<li class="col-md-2" id="elemento-'.$id.'" contenteditable="false"><b><img style="width:150px" src="../images_carousel/'.$nombre.'"></b></li>';
                                ?>
						</ul>
