...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from productos_tallas where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>Presentaciones del producto - Editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="productos-tallas.php">Presentaciones del producto</a></li>
				<li class="active">Presentaciones del producto [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Presentaciones del producto - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="productos-tallas.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
...
<li class="active"><a href="#ca" data-toggle="tab" aria-expanded="true">Datos Generales</a></li>
...
<option value="">Seleccione...</option>
 <?php  $rt=mysqli_query($link,"select * from tallas where estatus='si'");
 while($cat=mysqli_fetch_assoc($rt)){?>
 
 <option <?php  if($consulta["id_talla"]==$cat["id"]) echo "selected"; ?> value="<?=$cat["id"]?>"><?=$cat["nombre_es"]?></option>
 <?php }
 ?>
									...
									<div class="form-group">
										<label class="control-label">Multiplicador <small>(valor que ser&aacute; multiplicado por el precio base del producto)</small></label>
<input type="text" name="multiplicador" id="multiplicador" class="form-control"  required value="<?=$consulta["multiplicador"]?>">
									</div>
