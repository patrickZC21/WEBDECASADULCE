...
if(isset($_GET["eliminar"])){
	eliminar('productos_imagenes',$_GET["eliminar"],$link); $hide2="";
}
...
if($ext!=""){		
			 	            $actual_image_name =date("H_i_s")."prod".".".strtolower($ext);
							$tmp = $_FILES['foto']['tmp_name'];
							if(move_uploaded_file($tmp, $RUTA.$actual_image_name))
								{
									mysqli_query($link,"update productos_imagenes set foto='".$actual_image_name."'  where id=".$_POST["id"]."") ;
								  }
}else{
...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into productos_imagenes values(NULL,".$_SESSION["id_prod"].",NULL,NULL)");
...
if($ext!=""){		
							...
							if(move_uploaded_file($tmp, $RUTA.$actual_image_name))
								{
									mysqli_query($link,"update productos_imagenes set foto='".$actual_image_name."'  where id=".$id."") ;
								  }
}else{
	$hide=""; $sms="Imagen invalida, solo formatos .jpg o .png";
	}								  
...
<head>
	<meta charset="utf-8" />
	<title>productos_imagenes - </title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class=""><a href="productos.php">Productos Imágenes</a></li>
				<li class="active">Productos Imágenes</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<!-- END page-header -->
			<a href="productos-imagenes-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
			
		&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="productos-imagenes-ordenar.php" class="btn btn-default btn-lg">Ordenar Imagénes</a>
			<br><br>
			<!-- BEGIN table -->
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						 ...
						 <th class="no-sort" style="white-space: nowrap">Imágen</th>
...
$sql1=mysqli_query($link,"select * from  productos_imagenes where id_producto=".$_SESSION["id_prod"]." order by orden ASC");
...
<a href="productos-imagenes-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>
