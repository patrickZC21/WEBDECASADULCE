<?php session_start(); include "../conex.php";
	...
	$consulta = "SELECT * FROM  modelo where   estatus='si' ORDER BY orden";
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Modelos [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
