...
<head>
	<meta charset="utf-8" />
	<title>Imágenes Carousel Home nuevo</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Imágenes Carousel Home [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Imágenes Carousel Home - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="slider.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
...
<ul class="nav nav-tabs" id="nav-tabs">
					<li class="active"><a href="#es" data-toggle="tab" aria-expanded="true">Datos</a></li>
						...
						<h5>Tamaño recomendado 1577 * 498 px</h5>		
