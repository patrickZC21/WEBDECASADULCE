...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from _textos where id=".$_GET["id"].""));
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Textos [editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">TEXTOS - EDITAR</a></li>
						
					</ul>
				</div>
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="textos.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form"> 
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Textos [p&aacute;gina].</p>
									
										<div class="form-group">
										<label class="control-label">Texto ES</label>
<textarea   name="texto_ES" id="texto_ES" class="form-control" ><?=$consulta["texto_ES"]?></textarea>
									</div>
									
									<div class="form-group">
										<label class="control-label">Texto EN</label>
<textarea   name="texto_EN" id="texto_EN" class="form-control"  ><?=$consulta["texto_EN"]?></textarea>
									</div>
									
									
									<div class="form-group">
										<label class="control-label">Texto POR</label>
<textarea   name="texto_PO" id="texto_PO" class="form-control"  ><?=$consulta["texto_PO"]?></textarea>
									</div>
