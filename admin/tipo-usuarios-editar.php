...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from tipo_usuario where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>Tipo Usuarios editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="tipo-usuarios.php">Tipo Usuarios</a></li>
				<li class="active">Tipo Usuarios [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Tipo Usuarios - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="tipo-usuarios.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Tipo Usuarios [Editar].</p>
...
<ul class="nav nav-tabs" id="nav-tabs">
								<li class="active"><a href="#es" data-toggle="tab" aria-expanded="true">Datos ES</a></li>
					<li class=""><a href="#en" data-toggle="tab" aria-expanded="true">Datos EN</a></li>
...
<input type="text" name="tipo_es" id="tipo_es" class="form-control" value="<?=$consulta["tipo_es"]?>">
									</div>	
								...
								<div class="tab-pane " id="en">
									<div class="form-group">
										<label class="control-label">Tipo</label>
<input type="text" name="tipo_en" id="tipo_en" class="form-control" value="<?=$consulta["tipo_en"]?>">
									</div>	
