	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Listado de iconos disponibles</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div class="panel-heading">
				<span class="panel-title">Listado de Iconos</span>
			</div>
			<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-4"><i class="fa fa-arrow-circle-right"></i>&nbsp;nbsp;&nbsp;&nbsp;&nbsp;fa-arrow-circle-right</div>
