...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into subcategorias(id_categoria,nombre_es,nombre_en) values(
		".$_POST["id_categoria"].",
		'".$_POST["nombre_es"]."',
		'".$_POST["nombre_en"]."')");
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						 ...
						 <th class="no-sort" style="white-space: nowrap">Sub Categoría</th>
...
$sql1=mysqli_query($link,"select * from  subcategorias order by id DESC");
while($row1=mysqli_fetch_array($sql1)){ 

$subcategoria = mysqli_fetch_assoc(mysqli_query($link,"select nombre_es from categorias where id_categoria=".$row1["id_categoria"]."" ))
