<?php session_start(); include "../conex.php";
	...
	$consulta = "SELECT * FROM  redes_sociales where   estatus='si' ORDER BY orden";
...
<head>
	<meta charset="utf-8" />
	<title>Redes Sociales ordenar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Redes Sociales [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
		...
		$(function(){
			...
			lista.sortable({
                update: function(event,ui){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'redes-sociales-contralor.php',
                        dataType: 'json',
                        data: {
                            accion: 'ordenar',
                            puntos: ordenPuntos
			...
			formulario.on('submit',function(evento){ //Cuando el formulario se envía, vamos a insertar
				...
				$.ajax({
                    type: 'POST',
                    url: 'redes_sociales-controlador.php',
                    dataType: 'json',
                    data: {
                        accion: 'insertar',
                        nombre: nombre,
