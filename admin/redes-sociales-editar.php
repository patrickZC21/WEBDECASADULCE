...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from redes_sociales where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>Redes Sociales editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Redes Sociales [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Redes Sociales - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="redes-sociales.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
...
<ul class="nav nav-tabs" id="nav-tabs">
								...
								<div class="tab-pane fade active in" id="es">
									<div class="form-group">
										<label class="control-label">Nombre Red social</label>
<input type="text" name="nombre" id="nombre" class="form-control" value="<?=$consulta["nombre"]?>">
									</div>	
									
									
									<div class="form-group">
										<label class="control-label">Link</label>
<input type="text" name="link" id="link" class="form-control" value="<?=$consulta["link"]?>">
									</div>	
