<?php session_start(); include "../conex.php";
	...
	$consulta = "SELECT * FROM  datosbancarios where   estatus='si' ORDER BY orden";
	$resultado = mysqli_query($link, $consulta);
	$elementos = null;
	while ($datos = mysqli_fetch_assoc($resultado)){
		$elementos[$datos['id']] = $datos['banco'];
	}
...
<head>
	<meta charset="utf-8" />
	<title>Datos Bancarios ordenar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Datos Bancarios [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
		...
		$(function(){
			...
			lista.sortable({
                update: function(event,ui){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'datosbancarios-contralor.php',
                        dataType: 'json',
                        data: {
                            accion: 'ordenar',
                            puntos: ordenPuntos
			...
			formulario.on('submit',function(evento){ //Cuando el formulario se envía, vamos a insertar
				...
				$.ajax({
                    type: 'POST',
                    url: 'datosbancarios-controlador.php',
                    dataType: 'json',
                    data: {
                        accion: 'insertar',
                        nombre: nombre,
