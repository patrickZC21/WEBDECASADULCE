	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="items-tallas.php">Tallas</a></li>
				<li class="active">Tallas [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Tallas - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="items-tallas.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Tallas [Nuevo].</p>
									
									
<ul class="nav nav-tabs" id="nav-tabs">
<li class="active"><a href="#ca" data-toggle="tab" aria-expanded="true">General</a></li>
...
<input type="text" name="talla" id="talla" class="form-control" value="<?=$consulta["talla"]?>">
									</div>	
