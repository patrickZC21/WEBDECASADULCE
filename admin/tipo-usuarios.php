...
if(isset($_GET["eliminar"])){
	eliminar('tipo_usuario',$_GET["eliminar"],$link); $hide2="";
}

if (isset($_POST["btn_editar"])){
	if( $_POST["estatus"]==""){$estatus="no";}else{$estatus="si";}
	
		$update=mysqli_query($link,"update tipo_usuario    set 
		 estatus='".$estatus."',
...
if (isset($_POST["btn_guardar"])){
	...
	mysqli_query($link,"insert into tipo_usuario values(NULL,NULL,NULL,NULL)");
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Tipo Usuarios</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<!-- END page-header -->
			<a href="tipo-usuarios-nuevo.php" class="btn btn-default btn-lg">Nuevo <i class="ti-pencil"></i></a>
			...
			<table id="datatables-default" class="table table-striped table-condensed table-bordered bg-white">
				<thead>
					<tr>
						...
						<th class="no-sort" style="width:1%"></th>
						<th class="no-sort" style="white-space: nowrap">Tipo_es</th>
						<th class="no-sort" style="white-space: nowrap">Tipo_en</th>
				...
				<tbody>
				 ...
				 <?php 
                                ...
                                $sql1=mysqli_query($link,"select * from  tipo_usuario ");
					...
					<tr>
						...
						<td class="btn-col" style="white-space: nowrap">
							...
							<a href="tipo-usuarios-editar.php?id=<?=$row1["id"]?>" class="btn btn-default btn-xs"><i class="ti-pencil"></i></a>
						...
						<td  ><?=getSubString2($row1["tipo_es"])?></td>
						
							<td  ><?=getSubString2($row1["tipo_en"])?></td>
