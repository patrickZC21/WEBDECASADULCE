<?php session_start(); include "../conex.php";
	...
	$consulta = "SELECT * FROM  categorias where   estatus='si' ORDER BY orden";
...
<head>
	<meta charset="utf-8" />
	<title>Categorías ordenar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Categorías [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
	...
	<script>
		$(function(){
			...
			formulario.on('submit',function(evento){ //Cuando el formulario se envía, vamos a insertar
				...
				$.ajax({
                    type: 'POST',
                    url: 'categorias-controlador.php',
                    dataType: 'json',
                    data: {
                        accion: 'insertar',
                        nombre: nombre,
