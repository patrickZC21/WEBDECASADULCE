...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from slider where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>Imágenes Carousel Home editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="slider.php">Imágenes Carousel Home</a></li>
				<li class="active">Imágenes Carousel Home [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Imágenes Carousel Home - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="slider.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
...
<ul class="nav nav-tabs" id="nav-tabs">
								...
								<div class="tab-pane fade active in" id="es">
									<h5>Tamaño recomendado 1920 * 700 px</h5>		
