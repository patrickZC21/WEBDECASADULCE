<?php session_start(); include "../conex.php";
	...
	$consulta = "SELECT * FROM  tallas where   estatus='si' ORDER BY orden";
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Tallas [Ordenar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
