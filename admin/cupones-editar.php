...
$consulta = mysqli_fetch_array(mysqli_query($link, "select * from cupones where id=" . $_GET["id"] . ""));
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Cupones [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Cupones - Editar</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
				<form action="cupones.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									...
									<ul class="nav nav-tabs" id="nav-tabs">
										<li class="active"><a href="#es" data-toggle="tab" aria-expanded="true">General</a></li>
										...
										<div class="tab-content tab-content-bordered">
											...
											<div class="tab-pane fade active in" id="es">
												...
												<input type="text" name="codigo_cupon" id="codigo_cupon" class="form-control" value="<?= $consulta["codigo"] ?>">
											</div>
											<div class="form-group">
												<label class="control-label">Descripci&oacute;n</label>
												<input type="text" name="descripcion" id="descripcion" class="form-control" value="<?= $consulta["descripcion"] ?>">
											</div>
											...
											<div class="form-group">
												...
												<div style="display:flex; justify-content: space-between">
													...
													<div>
														<input type="radio" name="tipo" id="tipo" value="fijo" <?=$consulta["tipo"] === 'fijo' ? 'checked' : null; ?>> Fijo
													</div>

													<div>
														<input type="radio" name="tipo" id="tipo" value="porcentaje"  <?=$consulta["tipo"] === 'porcentaje' ? 'checked' : null; ?>> Porcentaje
													</div>
											...
											<div class="form-group">
												...
												<input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" value="<?= $consulta["fecha_inicio"] ?>" >
											</div>

											<div class="form-group">
												<label class="control-label">Fecha_fin</label>
												<input type="date" name="fecha_fin" id="fecha_fin" class="form-control"  value="<?= $consulta["fecha_fin"] ?>">
											</div>

											<div class="form-group">
												<label class="control-label">Minimo_compra $.</label>
												<input type="text" name="minimo_compra" id="minimo_compra" class="form-control" value="<?= $consulta["minimo_compra"] ?>">
											</div>

											<div class="form-group">
												<label class="control-label">Usos</label>
												<input type="text" name="usos" id="usos" class="form-control" value="<?= $consulta["usos"] ?>">
											</div>
