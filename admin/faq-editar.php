...
$consulta=mysqli_fetch_array(mysqli_query($link,"select * from faq where id=".$_GET["id"].""));
...
<head>
	<meta charset="utf-8" />
	<title>Preguntas Frecuentes (FAQ) editar</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Preguntas Frecuentes (FAQ) [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Preguntas Frecuentes (FAQ) - EDITAR</a></li>
				...
				<!-- END wizard-header -->
				<!-- BEGIN wizard-form -->
<form action="faq.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_editar').html('Editando ...')" name="wizard_form">
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Categorías [Editar].</p>
...
<input type="text" name="titulo" id="titulo" class="form-control" value="<?=$consulta["titulo"]?>">
									</div>	
<div class="form-group">
										<label class="control-label">Respuesta</label>
<input type="text" name="texto" id="texto" class="form-control" value="<?=$consulta["texto"]?>">
									</div>
