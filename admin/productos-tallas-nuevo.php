...
<head>
	<meta charset="utf-8" />
	<title>Presentaciones del producto - Nuevo</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Presentaciones del producto [Nuevo]</li>
			</ul>
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">Presentaciones del producto - NUEVO</a></li>
						
					</ul>
				</div>
				
<form action="productos-tallas.php" method="post" enctype="multipart/form-data" onSubmit="$('#btn_guardar').html('Guardando ...')" name="wizard_form">
...
<input type="text" name="multiplicador" id="multiplicador" class="form-control"  required>
									</div>
