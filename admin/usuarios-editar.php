	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Usuarios [Editar]</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			...
			<div id="rootwizard" class="wizard wizard-full-width">
				...
				<div class="wizard-header">
					<ul class="nav nav-pills">
						<li class="active"><a href="#tab1" data-toggle="tab">USUARIO - Editar</a></li>
						...
						<div class="tab-pane active" id="tab1">
							...
							<div class="row">
								...
								<div class="col-md-6 col-md-offset-3">
									<p class="desc m-b-20">Usuarios [Editar].</p>
...
<input type="text" name="email" id="email" class="form-control" value="<?=$row1["email"]?>">
									</div>	
<div class="form-group">
										<label class="control-label">Login</label>
<input type="text" name="login" id="login" class="form-control" value="<?=$row1["login"]?>">
									</div>	
									
									<div class="form-group">
										<label class="control-label">Nombres</label>
<input type="text" name="nombres" id="nombres" class="form-control" value="<?=$row1["nombres"]?>">
									</div>	
 ...
 <select name="estatus" class="form-control ">
                                           <option  <?php if ($row1["estatus"]=='activo'){echo "selected";} ?> value='activo' >Activo</option>
                                           <option  <?php if ($row1["estatus"]=='desactivo'){echo "selected";}?> value='desactivo'>Desactivo</option>
                                        </select>
									</div>								
 ...
 <select style="visibility:hidden" name="estatus" class="form-control ">
                                           <option  <?php if ($row1["estatus"]=='activo'){echo "selected";} ?> value='activo' >Activo</option>
                                           <option  <?php if ($row1["estatus"]=='desactivo'){echo "selected";}?> value='desactivo'>Desactivo</option>
                                        </select>
									</div>								
